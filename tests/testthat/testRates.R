...
# test warnings
test_that("rates - warnings are generated when field collisions between data and functions", {
  expect_warning(phe_rate(mutate(data.frame(area  =c("Area1","Area2","Area3"),
                                            obs   =c(65,80,30),
